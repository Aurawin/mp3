...
import static com.aurawin.mp3.frame.Kind.fInitialKey;
import static com.aurawin.mp3.frame.Kind.fSubTitleDescription;

public class TKEY extends Processor implements Process {
    @Override
    public boolean process( MemoryStream Stream){
        Owner.Length=Owner.Reader.TagFrame.Header.Length;
        Owner.StreamStart=Stream.position();
        Owner.Data=Owner.pldText;
        Owner.Reader.TagFrame.Kind=fInitialKey;
